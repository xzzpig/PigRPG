...
public class CommandHelp
{
	...
	private CommandHelp(String command,String describe,String useage,String var,CommandHelp uphelp){
		if(command == null)
			command = "error";
		this.command = command;
		if(describe == null)
	...
	public CommandHelp addSubCommandHelp(String command,String describe,String useage,String var){
		CommandHelp sub = new CommandHelp(this.command+" "+command,describe,useage,var,this);
		subs.add(sub);
		return sub;
	}
