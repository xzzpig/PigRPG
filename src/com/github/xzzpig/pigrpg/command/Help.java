...
public class Help {
	public static final TCommandHelp PIGRPG = new TCommandHelp("pigrpg", "PigRPG的主命令", "输入/pr help 查看帮助");

	static {
		TCommandHelp pr_friend = PIGRPG.addSubCommandHelp("friend", "获取 好友系统 的帮助", "输入/pr friend help 查看帮助", "");
		TCommandHelp pr_trade = PIGRPG.addSubCommandHelp("trade", " 获取 交易系统 的帮助", "输入/pr trade help 查看帮助", "");
		TCommandHelp pr_chat = PIGRPG.addSubCommandHelp("chat", "  获取 聊天系统 的帮助", "输入/pr chat help 查看帮助", "");
		TCommandHelp pr_tel = PIGRPG.addSubCommandHelp("tel", "   获取 传送系统 的帮助", "输入/pr tel help 查看帮助", "");
		TCommandHelp pr_sale = PIGRPG.addSubCommandHelp("sale", "  获取 拍卖系统 的帮助", "输入/pr sale help 查看帮助", "");
		TCommandHelp pr_equip = PIGRPG.addSubCommandHelp("equip", " 获取 装备系统 的帮助", "输入/pr equip help 查看帮助", "");
		TCommandHelp pr_team = PIGRPG.addSubCommandHelp("team", "  获取 组队系统 的帮助", "输入/pr team help 查看帮助", "");
		TCommandHelp pr_score = PIGRPG.addSubCommandHelp("score", " 获取 计分板系统 的帮助", "输入/pr score help 查看帮助", "");
		TCommandHelp pr_list = PIGRPG.addSubCommandHelp("list", "  获取 所有列表", "输入/pr list help 查看帮助", "");
		...
		TCommandHelp pr_friend_del = pr_friend.addSubCommandHelp("del", "   处理好友删除请求", "", "");
		...
		pr_score.addSubCommandHelp("show", "设置是否显示计分板","<player>默认为自己","[true|false] <player>");
